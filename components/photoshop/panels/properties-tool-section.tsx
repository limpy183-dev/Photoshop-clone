...
/**
 * The Properties panel's tool-specific section — the controls that change with
 * the active tool rather than with the active layer.
 *
 * Split out of `properties-panel.tsx`, which now owns only the document- and
 * layer-scoped sections. Typography does the bulk of the work here: variable
 * font axes, OpenType features, font matching and text-on-path editing.
 */

import * as React from "react"
import { makeCanvas } from "@/editor/canvas/utils"
import { Slider } from "@/components/ui/slider"
import { Type as TypeIcon, Square, Pen, Paintbrush, Eraser, Move } from "lucide-react"
...
export function ToolSection({ tool, layer, brush, eraser, cloneSource, dispatch, requestRender, commit, foreground, background, doc }: {
  tool: ToolId
  layer: Layer | null
