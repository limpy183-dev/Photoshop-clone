...
import type { QuickMaskPaintMode } from "@/editor/types"
import {
  CustomShapeOptions,
  DirectSelectOptions,
  GradientOptions,
  ...
  TransformOptions,
  TypeOptions,
} from "@/components/photoshop/options-bar-tools"
...
export function OptionsBar() {
  const { tool, brush, dispatch, eraser, cloneSource, activeDoc } = useEditorSelector((editor) => editor)
