...
export const PANEL_DEFINITIONS: PhotoshopPanelDefinition[] = [
  ...
  { id: "accessibility-audit", label: "Editor Accessibility Metadata Audit", stack: "lower", category: "Inspection and Guides", complexity: "specialized", icon: Activity, keywords: ["accessibility", "keyboard", "aria", "focus", "touch"], render: () => <AccessibilityAuditPanel /> },
