...
import { EditorCloseDialog } from "@/components/photoshop/editor/close-dialog"
import {
alphaBounds,
cloneCanvas,
...
import { createHistoryJumpScheduler,type HistoryJumpScheduler } from "@/editor/history-jump-scheduler"
import { recordHistoryLogEntryFromStorage } from "@/editor/preferences-engine"
import { purgePsbTileViewCaches } from "@/editor/psb-tile-view"
import {
planPurgeTargets,
type PurgeResult,
type PurgeTarget,
} from "@/editor/purge-commands"
import { RenderBus,type MergedRenderChange,type RenderChange } from "@/editor/render-bus"
import {
maskBounds,
...
export function EditorProvider({ children }: { children: React.ReactNode }) {
  ...
  const value: EditorContextValue = React.useMemo(() => ({
    ...
    state.actions, state.recordingActionId, state.isPlayingAction, state.activeSmartFilterMaskTarget, state.maskEditLayerId, documentStatuses, documentHistoryVersions,
