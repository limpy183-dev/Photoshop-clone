...
const records = [
  ...
  },
  {
    ...
    kind: "format",
    status: "approximation",
    summary: "OpenEXR import uses parse-exr to decode supported pixel channels into tone-mapped editable previews and exports flattened uncompressed scanline EXR as Y, RGB, or RGBA in half or float samples.",
    limitations: ["Multipart/deep/tiled EXR, arbitrary production channel semantics, production OCIO transforms, and true HDR editing are not implemented."],
  ...
  },
  {
    ...
    kind: "format",
    status: "approximation",
    summary: "PDF import renders pages to flattened editable raster layers through PDF.js, and export writes flattened single-page or multi-page PDFs from canvas composites.",
    limitations: ["No editable vectors, embedded font editing, transparency group preservation, annotations, or prepress-grade metadata authoring."],
  ...
  },
  {
    ...
    kind: "format",
    status: "approximation",
    summary: "EPS import renders a safe subset of EPS vector operators including basic paths, curves, colors, strokes, fills, and rectangles, and export writes flattened Level 2 raster EPS data.",
    limitations: ["No arbitrary PostScript execution, font resolution, separations, overprint handling, advanced graphics state, or full editable vector import."],
  ...
  },
  {
    ...
    kind: "format",
    status: "approximation",
    summary: "HEIF/HEIC import uses the bundled decoder for primary-image RGBA previews, and export can write browser-compatible AV1-in-HEIF/AVIF payloads when the browser encoder is available.",
    limitations: ["No HEVC/HEIC encoder, auxiliary/depth image handling, live-photo pairing, or full certified ICC conversion; AVIF export metadata is authored through XMP/ICC UUID boxes."],
    recommendedAction: "Use HEIF/HEIC import for flattened editing and AVIF-backed HEIF export where supported; keep HEVC/HEIC production encoding in dedicated tooling.",
    testCoverage: "unit",
  },
  {
    id: "format.jpeg2000",
    ...
    kind: "format",
    status: "approximation",
    summary: "JPEG 2000 import decodes supported JP2/J2K codestreams into editable RGBA previews, and export writes flattened RGB J2K codestreams through the browser-compatible OpenJPEG encoder.",
    limitations: ["No JPX/JPM authoring, advanced color-box metadata, alpha channels, or production multi-resolution profile controls."],
  ...
  },
  {
    ...
    kind: "export",
    status: "usable",
    summary: "Exports browser canvas encodings plus app-authored TIFF, TGA, PNM, interlaced PNG, progressive JPEG, PNG/JPEG metadata, ICC conversion, and PNG/JPEG ICC profile chunks.",
    limitations: ["Content credentials are still reported rather than embedded in browser raster outputs; non-PNG/JPEG formats may not carry ICC payloads."],
