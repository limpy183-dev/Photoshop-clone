import { canPluginUsePermission, permissionsForPluginActionDescriptors } from "@/editor/plugin-system"
import type { FileSystemFileHandleLike } from "@/components/photoshop/editor/context"
import type {
  Layer,
  LayerStyle,
