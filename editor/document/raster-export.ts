...
RasterExportOptions,
SvgExportOptions,
} from "@/editor/document/io-types"
import { makeIoCanvas,renderDocumentComposite } from "@/editor/document/rendering"
import { exportRasterImageDataToBlob } from "@/editor/export/worker"
import {
...
import { planTileOnlyExport } from "@/editor/tile-only-export-planning"
import { composeDocumentTile } from "@/editor/tile-only-pipeline"
import type {
ColorProfileName,
DocumentReport,
PsDocument
} from "@/editor/types"
import { collectEmbeddedTypographyFonts } from "@/editor/typography-engine"
import { blobToZipEntry,createStoredZipBlob,type StoredZipEntry } from "@/editor/zip-packaging"

import { escapeForCData } from "@/editor/document/io-shared"
...
export async function exportAnimationDataUrl(
  ...
  const { collectAnimationFrames, encodeAnimatedGif, encodeApngFromFrames, encodeAnimatedWebP, bytesToDataUrl } = await import("@/editor/animation-encoding")
