...
import {
  ...
  pngChunk,
  u32BE,
} from "@/editor/raster/codec-utils"
import {
  buildXmpPacket,
  bytesFromInput,
...
import { TGA_DEVELOPER_PREFIX, TGA_DEVELOPER_TAG_METADATA, TGA_SIGNATURE } from "@/editor/raster/codecs-internal"
import type {
  HeicEncodeOptions,
  HeifEncodeOptions,
  JpegEncodeOptions,
...
async function loadMozJpegEncoder() {
  ...
  const nodeAdapter = await import(/* webpackIgnore: true */ "./codecs.node")
