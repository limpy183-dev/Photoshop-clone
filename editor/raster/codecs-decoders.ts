...
import { sniffRasterDimensions } from "@/editor/document/import-sniffers"
import { imageDataFromRgba, readAscii } from "@/editor/raster/codec-utils"
import { clamp8, scaleSample, TGA_DEVELOPER_PREFIX, TGA_DEVELOPER_TAG_METADATA, TGA_SIGNATURE } from "@/editor/raster/codecs-internal"
import { readExrChannelInfo, readExrDataWindow } from "@/editor/raster/codecs-exr-inspect"
import type { DecodedRaster } from "@/editor/raster/codecs-types"
...
export async function decodeAdvancedRasterBufferAsync(buffer: ArrayBuffer, name = "", mime = ""): Promise<DecodedRaster | null> {
  ...
  if (signature.isJpeg2000) {
    const { decodeJpeg2000Buffer } = await import("@/editor/raster/codecs-jpeg2000")
